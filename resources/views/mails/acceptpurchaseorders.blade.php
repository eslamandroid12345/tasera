    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;">   نفيدكم بانه تمت الموافقه على نشر طلب الشراء الخاص بكم بعنوان : {{ $data['title'] }}  ورقم مرجعي {{ $data['body'] }} </p>
                ...
                <p>We inform you that your purchase order has been approved to be published with the address: {{ $data['title'] }} and reference number {{ $data['body'] }}</p>
