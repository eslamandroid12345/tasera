    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;"> نشكر لك ترقية حسابكم معنا في :  {{ $data['package']->name_ar }}</p>
                <p style="text-align: right;direction: rtl;">نتمنى لكم رحلة سعيدة.</p>
                <p style="text-align: right;direction: rtl;">لمراجعة تفاصيل الاشتراك تفضل بزيارة رابط تفاصيل الاشتراك <a href="https://quotation.sa/profile/subscription-details">https://quotation.sa/profile/subscription-details</a></p>

                <p>Dear partner, {{ $data['user']->company->t('name') }}</p>
                <p>Thank you for upgrading your account with us to the :  {{ $data['package']->name_en }}</p>
                <p>We wish you a happy trip</p>
                <p>To review the subscription details, visit the subscription details link <a href="https://quotation.sa/profile/subscription-details">https://quotation.sa/profile/subscription-details</a></p>
            </td>
        </tr>
        <tr>
            <td align="center">
