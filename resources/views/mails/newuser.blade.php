...
<div style="background: linear-gradient(363deg, #f8ecff 0%, rgba(217, 217, 217, 0) 100%); padding: 0; overflow: hidden;">
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                <p style="text-align: right;direction: rtl;">يوجد حساب فرعي جديد بانتظار الموافقة، لشركة برقم مرجعي : {{ $data['user']->company->reference_id }}</p>
                ...
                <p>There is a new sub-user awaiting approval, with a reference number : {{ $data['user']->company->reference_id }}</p>
