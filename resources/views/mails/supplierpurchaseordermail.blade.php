    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;"> تم نشر طلب شراء بنفس مجالكم المسجل في منصة تسعيرة ، قم بالدخول ورفع عرض السعر الخاص بكم: {{ $data['body'] }}</p>
                ...
                <p>A purchase request has been published with the same field as yours registered on quotation platform. Log in and raise your price offer : {{ $data['body'] }}</p>
