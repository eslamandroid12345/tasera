    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;">نرحب بك في منصة تسعيرة ونفيدك باعتماد تسجيل حسابكم كمشتري في منصة تسعيرة برقم مرجعي {{ $data['user']->company->reference_id }}</p>
                ...
                <p>We welcome you to quotation platform and glad to inform you that your account registration been approved , your account as a buyer on quotation platform with reference number {{ $data['user']->company->reference_id }}</p>
