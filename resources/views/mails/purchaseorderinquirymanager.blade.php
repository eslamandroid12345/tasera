...
{{--                <p style="text-align: right;direction: rtl;">عزيزنا الشريك, {{ $data['user']->company->t('name') }}</p>--}}
                <p style="text-align: right;direction: rtl;">يوجد استفسار جديد بانتظار الموافقة من شركة: {{ $data['company_name'] }}</p>
...
{{--                <p>Dear partner, {{ $data['user']->company->t('name') }}</p>--}}
                <p>There is a new inquiry awaiting approval from the company: {{ $data['company_name'] }}</p>
