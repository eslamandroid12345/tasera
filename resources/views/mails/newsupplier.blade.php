...
<div style="background: linear-gradient(363deg, #f8ecff 0%, rgba(217, 217, 217, 0) 100%); padding: 0; overflow: hidden;">
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                <p style="text-align: right;direction: rtl;">تم تسجيل مورد جديد في منصة تسعيرة بانتظار الموافقة. رقم المورد المرجعي: {{ $data['company']->reference_id }}</p>
{{--                <p style="text-align: right;direction: rtl;">تم تسجيل شركة جديدة من نوع مورد في المنصة تحت اسم: {{ $data['company']->t('name') }} و تحت رقم مرجعى : {{ $data['company']->reference_id }}</p>--}}
                ...
                <p>A new supplier has been registered on Quotation platform and is awaiting approval. Supplier's reference number: {{ $data['company']->reference_id }}</p>
