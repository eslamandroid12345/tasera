    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;">رمز OTP الخاص بك لتأكيد البريد الإلكتروني هو: {{ $data['otp']->code }}</p>
                ...
                <p>Dear partner,</p>
                <p>Your OTP code to confirm your email address is: {{ $data['otp']->code }}</p>
