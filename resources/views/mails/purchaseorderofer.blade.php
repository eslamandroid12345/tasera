    ...
    <table class="container" width="100%" border="0" cellspacing="0" cellpadding="0" style="max-width: 800px; margin: 0 auto;">
        ...
        <tr>
            <td>
                ...
                <p style="text-align: right;direction: rtl;">نفيدكم بانه تمت الموافقه على عرض السعر الخاص بطلب الشراء رقم  {{ $data['order_reference_id'] }} ورقم عرض السعر المرجعي الخاص بك هو {{ $data['offer_reference_id'] }}</p>
                <p style="text-align: right;direction: rtl;"><a href="{{ env('purchase_orders').$data['order_reference_id'] }}">تفضل بزيارة طلب الشراء: {{ env('purchase_orders').$data['order_reference_id'] }}</a></p>
                ...
                <p>We inform you that your price quote for purchase order No. {{ $data['order_reference_id'] }} has been approved, your quotation's reference number is {{ $data['offer_reference_id'] }}</p>
                <p style="text-align: right;direction: rtl;"><a href="{{ env('purchase_orders').$data['order_reference_id'] }}">You can visit the purchase order: {{ env('purchase_orders').$data['order_reference_id'] }}</a></p>
