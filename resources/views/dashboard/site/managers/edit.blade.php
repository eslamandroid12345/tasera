                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="is_send" type="checkbox" id="checkboxPrimary5"
                                                    {{ old('is_send') == 'on' ? 'checked' : ($manager->is_send ? 'checked' : '') }}>
                                                <label for="checkboxPrimary5">@lang('dashboard.Send')</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
