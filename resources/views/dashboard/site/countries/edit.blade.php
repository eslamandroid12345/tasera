                    ...
                    <div class="card">
                        <form action="{{ route('countries.update',$country->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.country')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_ar" type="text" class="form-control"
                                                   ...
                                                   value="{{ $country->name_ar }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('name_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" type="text" class="form-control"
                                                   id="exampleInputEmail1" value="{{ $country->name_en }}"
                                                   placeholder=""
                                                   required>
                                        </div>
                                    </div>
