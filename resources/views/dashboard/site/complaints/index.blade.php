                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('dashboard.complaints')</h3>
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                @forelse($complaints as $key => $complaint)
                                    <tr>
                                        ...
                                        <td>{{$complaint->is_read_value}}</td>
                                        <td>
                                            <div class="operations-btns" style="">
                                                <a href="{{ route('complaints.show', $complaint['id']) }}" class="btn  btn-dark">@lang('dashboard.Show')</a>
