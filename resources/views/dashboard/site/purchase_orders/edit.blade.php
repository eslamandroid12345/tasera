                    ...
                    <div class="card">
                        <form action="{{ route('companies.update',$company->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Edit') @lang('dashboard.company')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_ar" type="text" class="form-control"
                                                   ...
                                                   value="{{ $company->name_ar }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('name_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" type="text" class="form-control"
                                                   id="exampleInputEmail1" value="{{ $company->name_en }}" placeholder=""
                                                   required>
                                        </div>
                                    </div>
                                    @error('name_en')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="type">
                                                    <option {{$company->type=='buyer'?'selected':''}} value="buyer">@lang('dashboard.buyer')</option>
                                                    <option {{$company->type=='supplier'?'selected':''}} value="supplier">@lang('dashboard.supplier')</option>
                                            </select>
                                        </div>
                                    </div>
                                    @error('city_id')
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select id="select2" name="fields[]" class="select2 select2-hidden-accessible" multiple style="width: 100%;" tabindex="-1" aria-hidden="true">
                                            @foreach($fields as $item)
                                                <option @if($company->fields !== null && in_array($item['id'], $company_fields->toArray())) selected @endif value="{{$item['id']}}">{{$item->t('name')}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="website_url" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $company->website_url }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('website_url')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">@lang('dashboard.authorization_file')</label>
                                            <input name="authorization_file" type="file" class="form-control"
                                                   id="exampleInputEmail1"  placeholder=""
                                                   >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="commercial_registration_no" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $company->commercial_registration_no }}" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="commercial_registration_expiry_date" type="date" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $company->commercial_registration_expiry_date }}" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="is_tax_exempt"  required id="taxExemptYes" value="1" {{$company->is_tax_exempt==1 ?'checked':''}}>
                                                <label class="form-check-label" for="taxExemptYes">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="is_tax_exempt" required  id="taxExemptNo" value="0"  {{$company->is_tax_exempt==0 ?'checked':''}}>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="tax_registration_no" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $company->tax_registration_no }}" placeholder="" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="city_id">
                                                ...
                                                <option {{$company->city->id==$item->id?'selected':''}} value="{{$item->id}}">{{$item->t('name')}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $company->phone }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
