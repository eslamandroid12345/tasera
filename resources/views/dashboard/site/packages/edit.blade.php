...
@section('title', __('dashboard.Edit') . ' ' . __('dashboard.packages'))
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_ar" type="text" class="form-control"
                                                   ...
                                                   value="{{ $package->name_ar }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('name_ar')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" type="text" class="form-control"
                                                   id="exampleInputEmail1" value="{{ $package->name_en }}" placeholder=""
                                                   required>
                                        </div>
                                    </div>
                                    @error('name_en')
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="price" type="text" class="form-control"
                                                   id="price" value="{{ $package->price }}" placeholder=""
                                                   required>
                                        </div>
                                    </div>
                                    @error('price')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="color" name="color" id="favcolor" value="{{$package->color??'#ff0000'}}" required>
                                        </div>
                                    </div>
                                    @error('color')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="subscription_months" type="text" class="form-control"
                                                   id="price" value="{{ $package->subscription_months }}" placeholder=""
                                                   >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="special_offers" type="text" class="form-control"
                                                   id="price" value="{{ $package->special_offers }}" placeholder=""
                                                   >
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="can_add_sub_user"  required id="can_add_sub_userYes" value="1" {{$package->can_add_sub_user?'checked':''}}>
                                            <label class="form-check-label" for="can_add_sub_userYes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="can_add_sub_user" required  id="can_add_sub_userNo" value="0"  {{$package->can_add_sub_user=='0'?'checked':''}}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="has_verified_badge"  required id="has_verified_badgeYes" value="1" {{$package->has_verified_badge=='1'?'checked':''}}>
                                            <label class="form-check-label" for="has_verified_badgeYes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="has_verified_badge" required  id="has_verified_badgetNo" value="0"  {{$package->has_verified_badge=='0'?'checked':''}}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="can_view_company_file"  required id="can_view_company_fileYes" value="1" {{$package->can_view_company_file=='1'?'checked':''}}>
                                            <label class="form-check-label" for="can_view_company_fileYes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="can_view_company_file" required  id="can_view_company_fileNo" value="0"  {{$package->can_view_company_file=='0'?'checked':''}}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="is_fallback"  required id="is_fallbackYes" value="1" {{$package->is_fallback=='1'?'checked':''}}>
                                            <label class="form-check-label" for="is_fallbackYes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="is_fallback" required  id="is_fallbackNo" value="0"  {{$package->is_fallback=='0'?'checked':''}}>
