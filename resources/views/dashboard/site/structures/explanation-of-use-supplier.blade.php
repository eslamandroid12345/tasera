...
@section('title', __('dashboard.content') . ' ' . __('dashboard.explanation-of-use-supplier'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('explanation-of-use-supplier-content.store') }}" method="post" autocomplete="off"
                              enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.content') @lang('dashboard.explanation-of-use-supplier')</h3>
                            </div>
                            @csrf
                            <div class="card-body">
