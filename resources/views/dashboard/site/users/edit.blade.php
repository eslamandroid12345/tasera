                        ...
                        <form action="{{ route('users.update',$user->id) }}" method="post" autocomplete="off"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $user->phone }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputName1">@lang('dashboard.direct_manager_name')</label>
                                            <input name="direct_manager_name" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $user->direct_manager_name }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('direct_manager_name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="exampleInputName1">@lang('dashboard.direct_manager_email')</label>
                                            <input name="direct_manager_email" type="text" class="form-control"
                                                   id="exampleInputName1"
                                                   value="{{ $user->direct_manager_email }}" placeholder="" required>
                                        </div>
                                    </div>
                                    @error('direct_manager_email')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="row">
