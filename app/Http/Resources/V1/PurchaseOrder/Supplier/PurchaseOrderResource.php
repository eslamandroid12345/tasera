...
use App\Http\Resources\V1\PurchaseOrder\Buyer\PurchaseOrderOfferResource;
...
class PurchaseOrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'buyer' => new PurchaseOrderSimpleUserResource($this->user->company),
            'title' => $this->title,
            ...
            'demand_units' => PurchaseOrderDemandUnitResource::collection($this->demandUnits),
            'inquiries' => PurchaseOrderInquiryResource::collection($this->publishedInquiries),
